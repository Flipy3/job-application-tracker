...
function BreakdownCard({
  ...
  return (
    <div className="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm">
      <h3 className="text-sm font-semibold tracking-normal text-zinc-950">
        {title}
      </h3>

      {items.length === 0 ? (
        <p className="mt-4 rounded-md border border-dashed border-zinc-200 px-3 py-4 text-center text-sm text-zinc-500">
          {emptyMessage}
        </p>
      ) : (
